...
import { createProduct, getProductById,getAllReviews,deleteProductReview, postProductReview,getProducts, updateProduct, deleteProduct } from '../controllers/productController'
...
productRouter.put("/review", authMiddleware,  postProductReview).delete("/review",authMiddleware,deleteProductReview)
